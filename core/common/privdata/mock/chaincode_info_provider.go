...
func (fake *ChaincodeInfoProvider) ExplicitCollectionInfo(arg1 string, arg2 string, arg3 string, arg4 ledger.SimpleQueryExecutor) (*peer.StaticCollectionConfig, error) {
...
func (fake *ChaincodeInfoProvider) ExplicitCollectionInfoCallCount() int {
...
func (fake *ChaincodeInfoProvider) ExplicitCollectionInfoCalls(stub func(string, string, string, ledger.SimpleQueryExecutor) (*peer.StaticCollectionConfig, error)) {
	fake.explicitCollectionInfoMutex.Lock()
	defer fake.explicitCollectionInfoMutex.Unlock()
	fake.ExplicitCollectionInfoStub = stub
}

func (fake *ChaincodeInfoProvider) ExplicitCollectionInfoArgsForCall(i int) (string, string, string, ledger.SimpleQueryExecutor) {
	fake.explicitCollectionInfoMutex.RLock()
	defer fake.explicitCollectionInfoMutex.RUnlock()
...
func (fake *ChaincodeInfoProvider) ExplicitCollectionInfoReturns(result1 *peer.StaticCollectionConfig, result2 error) {
	fake.explicitCollectionInfoMutex.Lock()
	defer fake.explicitCollectionInfoMutex.Unlock()
...
func (fake *ChaincodeInfoProvider) ExplicitCollectionInfoReturnsOnCall(i int, result1 *peer.StaticCollectionConfig, result2 error) {
	fake.explicitCollectionInfoMutex.Lock()
	defer fake.explicitCollectionInfoMutex.Unlock()
	fake.ExplicitCollectionInfoStub = nil
